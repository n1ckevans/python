...
class User(models.Model):
    ...
    photo = models.ImageField(upload_to="static/user_images/", null=True, blank=True)
    objects = UserManager()
...
class Marker(models.Model):
    ...
    def __repr__(self):
        return f"<Marker object: id: {self.id}, title: {self.name}, photo: {self.photo}, coords: {self.lat}, {self.long}>"